...
$$
\text{链式法则：} \frac{dy}{dx} = \frac{dy}{du} \cdot \frac{du}{dx}
$$
</div>
...
$$
y \text{ 关于 } x \text{ 的一阶导数} = \frac{1}{x \text{ 关于 } y \text{ 的一阶导数}}
$$
</div>
...
$$y \text{ 关于 } x \text{ 的二阶导数} = - \frac{x \text{ 关于 } y \text{ 的二阶导数}}{(x \text{ 关于 } y \text{ 的一阶导数})^3}$$
